...
import { NUM_TARGETS, collectedObjs } from "./Targets";
...
export function AnimatedSpaceship(props) {
  ...
  const [InternalcollectedObjs, setcollectedObjs] = useState(8);
  ...
  useFrame(({ camera }) => {
    ...
    const cameraMatrix = new Matrix4()
      ...
      .multiply(
        new Matrix4().makeTranslation(0, translationValue, translationZValue)
      );
